...
class graf {
	...
	graf() { rozmiar=100000; lista_sasiadujaca=new vector<wierzcholek>[rozmiar]; lista_sasiedztwa=new vector<int>[rozmiar]; };
	graf(int r) { rozmiar=r; lista_sasiadujaca=new vector<wierzcholek>[rozmiar]; lista_sasiedztwa=new vector<int>[rozmiar]; };
